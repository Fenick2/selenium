...
def get_data(url):
    headers = {
        ...
        "User-Agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 "
                      "Safari/537.36 "
    }
...
def get_data_with_selenium(url):
    ...
    options.set_preference("general.useragent.override", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, "
